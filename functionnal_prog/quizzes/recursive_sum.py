...
Autrement dit, lorsque les éléments de l'itérable sont des nombres (types int ou float), la fonction n'a qu'à les sommer, mais lorsqu'un élément est itérable,
 la fonction doit faire un appel récursif sur celui-ci afin de récursivement sommer ses éléments. Plus précisément, votre fonction doit traiter les cas particuliers suivants:
